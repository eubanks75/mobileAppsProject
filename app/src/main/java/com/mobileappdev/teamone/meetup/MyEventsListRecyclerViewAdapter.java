...
/**
 * {@link RecyclerView.Adapter} that can display a {@link EventListItem} and makes a call to the
...
public class MyEventsListRecyclerViewAdapter extends RecyclerView.Adapter<MyEventsListRecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mIdView.setText("Id is " + mValues.get(position).id);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.text_view_contact);
            mContentView = (TextView) view.findViewById(R.id.text_view_event_name);
        }
